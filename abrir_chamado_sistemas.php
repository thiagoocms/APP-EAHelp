            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="categoria" class="form-control" required>
                        <option>Actyon(Web e Desktop)</option>
                        <option>Tactium</option>
                        <option>SZChat</option>
                        <option>Meridio</option>
                        <option>Sistema de SMS</option>
                      </select>
                    </div>
                    ...
                    <input type="hidden" name="prioridade" value='alta'>
            </form>
